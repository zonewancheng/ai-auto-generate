...
import { generateCombatEffect, adjustGeneratedImage, removeImageBackground, addAsset, getAssetsByType, deleteAsset, AssetRecord } from '../services/geminiService';
  ...
  const handleAdjust = useCallback(async () => {
    ...
    const handleRemoveBackground = useCallback(async () => {
        ...
        try {
            ...
            await addAsset({ type: 'combat-effect', prompt: `已移除背景 (原始: ${prompt})`, imageDataUrl: newImageDataUrl });
            loadHistory();
        } catch (err) {
